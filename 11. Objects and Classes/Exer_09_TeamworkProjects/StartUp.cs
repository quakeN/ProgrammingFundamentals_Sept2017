namespace Exer_09_TeamworkProjects
{
    using System;
    ...
    public class StartUp
    {
        public static void Main()
        {
            ...
            PrintTeams(teamsLeft, teamsDisbanded);
        }

        public static List<Team> AddTeamsInfo()
        {
            var teams = new List<Team>();
            int teamsCounter = int.Parse(Console.ReadLine());
        ...
        public static void PrintTeams(List<Team> teamsLeft, List<string> teamsDisbanded)
        {
